...
import { fetchTopHomeSlidesImages, fetchHomeFeatures } from '../../home/store/slice';
...
export function* topHomeSlidesImagesSaga() {
    yield all([takeEvery(fetchTopHomeSlidesImages, fetchTopHomeSlidesImagesHandler), takeEvery(fetchHomeFeatures, fetchHomeFeaturesHandler)]);
}
