...
import { fetchCart, addCart, updateByQuantityCart, detailsCart, deleteCart, addOrder, fetchPassedOrder, fetchReceivedOrder } from './slice';
import { addCartHandler, deleteCartHandler, detailsCartHandler, fetchCartHandler, updateByQuantityCartHandler } from './saga-handler/cart.generator';
