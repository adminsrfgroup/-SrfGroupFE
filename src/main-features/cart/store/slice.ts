...
export const entityOrder = (state: any) =>
	state[CART_KEY_IN_STORE].order.entity;
...
export const entityOrderReceived = (state: any) =>
	state[CART_KEY_IN_STORE].orderReceived.entity;
