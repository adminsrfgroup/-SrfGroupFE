          ...
          {entitiesReceivedRentRequestSelector.map(
            (item: IRentRequest, index: number) => (
              <DisplayItemReceived
                ...
                callbackAcceptRentRequest={(currentItem: IRentOffer) =>
              ...
              <Grid item xs={8}>
                <CardHeader
                  ...
                  avatar={
                    <Avatar
                      ...
                      alt="image not found"
                      onClick={(event: any) =>
                        redirectToPorfile(event, item?.receiverUser?.id)
                      }
                      role="img"
                    >
                ...
                {item.status === StatusRentRequest.STANDBY ? (
                  <Button
                    variant="outlined"
                    color="error"
                    onClick={(event) => removeRentRequest(event, item)}
                  >
                    {t<string>('common.label_cancel')}
                  </Button>
                ) : null}
                      ...
                      <ListItem alignItems="flex-start">
                        <ListItemText
                          ...
                          secondary={
                            <React.Fragment>
                              {convertDateTimeFromServer(
                                new Date(item?.rentOffer?.startDate)
                              )}
                            </React.Fragment>
                          }
                        />
                      ...
                      <ListItem alignItems="flex-start">
                        <ListItemText
                          ...
                          secondary={
                            <React.Fragment>
                              {convertDateTimeFromServer(
                                new Date(item?.rentOffer?.endDate)
                              )}
                            </React.Fragment>
                          }
                        />
    ...
    return (
      ...
      >
        ...
        <DialogActions style={{ justifyContent: 'start' }}>
          <Button
            onClick={() => setOpenAddSignatureRentRequestModal(false)}
            color="neutral"
          >
            {t<string>('common.label_cancel')}
          </Button>
              ...
              indexSelected !== item.id ? (
                ...
                >
                  <Button
                    variant="outlined"
                    color="neutral"
                    onClick={(event) => cancelAction(event, item)}
                  >
                    {t<string>('rentrequest.label_btn_refused')}
                  </Button>
                  <Button
                    variant="outlined"
                    color="success"
                    onClick={(event) => acceptAction(event, item)}
                  >
            ...
            indexSelected === item.id ? (
              ...
              >
                <Button
                  variant="outlined"
                  color="neutral"
                  onClick={(event) => cancelIndexAction(event)}
                >
                  {t<string>('common.label_cancel')}
                </Button>
