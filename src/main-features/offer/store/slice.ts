...
export const activePagePublicOffer = (state: any) => state[OFFER_KEY_IN_STORE].publicOffer.activePage;
...
export const activePageMyOffers = (state: any) => state[OFFER_KEY_IN_STORE].myOffers.activePage;
...
export const loadingEntitiesSellDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].sellDetailsOffers.loadingEntities;
export const entitiesSellDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].sellDetailsOffers.entities;
export const isLoadedSellDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].sellDetailsOffers.isLoaded;

//? ********************| RENT DETAILS OFFER SELECTORS |*******************/
export const loadingEntitiesRentDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].rentDetailsOffers.loadingEntities;
export const entitiesRentDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].rentDetailsOffers.entities;
export const isLoadedRentDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].rentDetailsOffers.isLoaded;

//? ********************| RENT DETAILS OFFER SELECTORS |*******************/
export const loadingEntitiesFindDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].findDetailsOffers.loadingEntities;
export const entitiesFindDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].findDetailsOffers.entities;
export const isLoadedFindDetailsOffers = (state: any) => state[OFFER_KEY_IN_STORE].findDetailsOffers.isLoaded;

//? ********************| COUNT OFFERS SELECTORS |*******************/
export const loadingEntityCountOffersByUser = (state: any) => state[OFFER_KEY_IN_STORE].countOffersByUser.loading;
export const entityCountOffersByUser = (state: any) => state[OFFER_KEY_IN_STORE].countOffersByUser.entity;

//? ********************| MOST REQUESTED OFFERS SELECTORS |*******************/
export const entitiesMostRequested = (state: any) => state[OFFER_KEY_IN_STORE].mostRequested.entities;

//? ********************| ALL ADVERTISING SELECTORS |*******************/
export const entityAdvertisingOffer = (state: any) => state[OFFER_KEY_IN_STORE].advertisingOffer.entity;
