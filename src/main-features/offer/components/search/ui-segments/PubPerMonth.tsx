        ...
        <CardActionArea component="a" onClick={() => rediretTo()}>
            <Card sx={{ mb: 3 }}>
                <CardHeader
                    avatar={
                        <Avatar
                            ...
                            src={getUserAvatar(advertising.user?.id, advertising.user?.imageUrl, advertising.user?.sourceConnectedDevice)}
                ...
                {advertising?.offerImages?.length ? (
                    <CardMedia component="img" height="194" image={getImageForOffer(advertising.id, advertising.offerImages[0].path)} alt="Paella dish" />
                ) : (
                    <CardMedia component="img" height="194" image={getBaseImageUrl(AllAppConfig.DEFAULT_LAZY_IMAGE)} alt="Paella dish" />
                )}
                <CardContent>
                    <div
                        dangerouslySetInnerHTML={{
                            __html: advertising?.description || '',
                        }}
                    ></div>
                </CardContent>
                ...
                <Collapse in={expanded} timeout="auto" unmountOnExit>
                    <CardContent>
                        ...
                        <Typography paragraph>
                            Add rice and stir very gently to distribute. Top with artichokes and peppers, and cook without stirring, until most of the liquid is absorbed, 15 to 18 minutes. Reduce heat
                            to medium-low, add reserved shrimp and mussels, tucking them down into the rice, and cook again without stirring, until mussels have opened and rice is just tender, 5 to 7
