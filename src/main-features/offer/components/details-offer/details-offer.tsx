...
export default function DetailsOfffer() {
    ...
    const [openReportOfferModal, setOpenReportOfferModal] =
    ...
    const [listCommentsForOffer, setListCommentsForOffer] = React.useState<
        any[]
    >([]);
    ...
    const loadingConversationSelector =
        useSelector(loadingConversation) ?? false;
    ...
    React.useEffect(() => {
        if (
            ...
            setIsFavoriteUser(
                entityPublicOfferSelector.myFavoriteUser || false
            );
            setTimeout(() => {
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-slide-description">
                        {t<string>(
                            'details_offer.description_dialog_report_offer'
                        )}
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button
                        onClick={handleCloseReportOfferModal}
                        color="neutral"
                    >
    ...
    const parentCallbackUpdateComment = (
        content: string,
        commentid: number
    ) => {
                            ...
                            <Card sx={{ mb: 3 }}>
                                <CardContent>
                                    ...
                                    >
                                        ...
                                        {entityPublicOfferSelector?.offer
                                            ?.available ? (
                                            <span className="color-purple ml-05">
                                                {' '}
                                                {t<string>(
                                                    'details_offer.available'
                                                )}
                                            </span>
                                        ) : (
                                            <span className="color-purple ml-05">
                                    ...
                                    >
                                        ...
                                        >
                                            {t<string>(
                                                'details_offer.label_details_offer'
                                            )}
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <div
                            ...
                            {isAuthenticated ? (
                                <Box sx={{ mb: 3 }}>
                                    <CommentDetailsOffer
                                        ...
                                        loadingListComments={
                                            loadingEntitiesCommentsOfferSelector
                                        }
                                        loadingUpdateEntity={
                                            loadingCommentsOfferSelector
                                        }
                                        loadingAddEntity={
                                            loadingCommentsOfferSelector
                                        }
                                        parentCallbackAddComment={
                                            handleCallbackAddComment
                                        }
                                        parentCallbackDeleteComment={
                                            handleCallbackDeleteComment
                                        }
                                        ...
                                        totalItems={
                                            totalItemsCommentsOfferSelector
                                        }
                                    />
                                </Box>
                            ) : null}
                            ...
                            entityPublicOfferSelector.offer?.typeOffer ===
                                ...
                                <Box sx={{ my: 3 }}>
                                    <Alert severity="warning">
                                        {t<string>(
                                            'details_offer.offer_contact_direct'
                                        )}
                                    </Alert>
                                </Box>
                            ) : null}
