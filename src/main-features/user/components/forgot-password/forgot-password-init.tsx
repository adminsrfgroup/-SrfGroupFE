...
import { initialValuesForgotPassword, validationSchemaForgotPassword } from '../../validation/validation-signin';
import { useFormik } from 'formik';
import { loadingResetInitPassword, resetInitSuccessPassword, resetPassword, resetPasswordInit } from '../../store/slice';
...
export default function ForgotPasswordInit() {
    ...
    const loadingResetInitPasswordSelector = useSelector(loadingResetInitPassword) ?? false;
    const resetInitSuccessPasswordSelector = useSelector(resetInitSuccessPassword) ?? false;
                ...
                >
                    ...
                    <Grid item xs={12} sm={6}>
                        <Breadcrumbs aria-label="breadcrumb">
                            ...
                            <Typography color="text.primary">{t<string>('signin.title_page_forgot_password')}</Typography>
                        </Breadcrumbs>
                    </Grid>
                </Grid>
                        ...
                        >
                            ...
                            <Box sx={{ mt: 1, pb: 2 }}>
                                <form onSubmit={formik.handleSubmit}>
                                        ...
                                        <Grid item xs={12}>
                                            {resetInitSuccessPasswordSelector ? (
                                                <Alert severity="success" sx={{ my: 2 }}>
                                                    {t<string>('forgot_password_init.message_send_mail_success')}
                                                </Alert>
                                            ) : null}
                                            <FormControl fullWidth error={formik.touched.email && Boolean(formik.errors.email)}>
                                                ...
                                                />
                                                <FormHelperText id="component-helper-text" data-testid="error-msg">
                                    ...
                                    <LoadingButton loading={loadingResetInitPasswordSelector} fullWidth variant="contained" color="neutral" type="submit" sx={{ mt: 3, mb: 2 }}>
