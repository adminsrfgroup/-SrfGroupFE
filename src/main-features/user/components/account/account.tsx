...
import { dataUrlToFile, getBase64, getFullnameUser, getUserAvatar } from '../../../../shared/utils/utils-functions';
import {
    currentUserSession,
    entityUpdateAvatar,
...
import { initialValuesAccount, initialValuesPasswordAccount, validationSchemaAccount, validationSchemaPasswordAccount } from '../../validation/validation-account';
...
export default function Account() {
    ...
    const [fileState, setFileState] = React.useState(getUserAvatar(currentUser.id, currentUser.imageUrl, currentUser.sourceConnectedDevice));
    ...
    React.useEffect(() => {
        if (currentUser) {
            // Set avatar
            setFileState(getUserAvatar(currentUser.id, currentUser.imageUrl, currentUser.sourceConnectedDevice));
            ...
            {loadingSessionSelector ? (
                ...
                >
                    <Grid item xs={12} sm={3} sx={{ textAlign: 'center' }}>
                        <Paper elevation={3} sx={{ p: 1 }}>
                            <Box sx={{ position: 'relative' }}>
                                ...
                                >
                                    ...
                                    {currentUser.sourceConnectedDevice == SourceProvider.MOBILE_BROWSER || currentUser.sourceConnectedDevice === SourceProvider.WEB_BROWSER ? (
                                        <Box
                                            sx={{
                                                position: 'absolute',
                                                bottom: 0,
                        ...
                        (entityCountOffersByUserSelector?.countFindOffers || entityCountOffersByUserSelector?.countRentOffers || entityCountOffersByUserSelector?.countSellOffers) ? (
                            <Box>
                            ...
                            <form onSubmit={formik.handleSubmit}>
                                <Box sx={{ mt: 2 }}>
                                    <h5 className="mb-4">
                                        ...
                                        {!showEditInfos ? (
                                            <IconButton aria-label="upload picture" className="float-right" component="span" color="success" onClick={() => setShowEditInfos(true)}>
                                                <EditIcon />
                                            </IconButton>
                                        ) : null}
                                    </h5>
                                ...
                                <form onSubmit={formikPassword.handleSubmit}>
                                    <Box sx={{ mt: 2 }}>
                                        <h5 className="mb-4">
                                            ...
                                            {!showEditPassword ? (
                                                <IconButton aria-label="upload picture" className="float-right" component="span" color="success" onClick={() => setShowEditPassword(true)}>
                                                    <EditIcon />
                                                </IconButton>
                                            ) : null}
                                        </h5>
                                        <Grid container spacing={2}>
                                            <Grid item xs={12}>
                                                <FormControl fullWidth error={formikPassword.touched.currentPassword && Boolean(formikPassword.errors.currentPassword)}>
                                                    ...
                                                    />
                                                    <FormHelperText id="component-helper-text">{formikPassword.touched.currentPassword && formikPassword.errors.currentPassword}</FormHelperText>
                                                </FormControl>
                                            </Grid>
                                        </Grid>
                                        ...
                                        <Grid container spacing={2} sx={{ mt: 1 }}>
                                            <Grid item xs={12} md={6}>
                                                <FormControl fullWidth error={formikPassword.touched.newPassword && Boolean(formikPassword.errors.newPassword)}>
                                                    ...
                                                    />
                                                    <FormHelperText id="component-helper-text">{formikPassword.touched.newPassword && formikPassword.errors.newPassword}</FormHelperText>
                                                </FormControl>
                                            </Grid>
                                            ...
                                            <Grid item xs={12} md={6}>
                                                <FormControl fullWidth error={formikPassword.touched.confirmNewPassword && Boolean(formikPassword.errors.confirmNewPassword)}>
                                                    ...
                                                    />
                                                    <FormHelperText id="component-helper-text">{formikPassword.touched.confirmNewPassword && formikPassword.errors.confirmNewPassword}</FormHelperText>
                                                </FormControl>
                                            </Grid>
                                        </Grid>
