...
export default function Account() {
    ...
    const updateSuccessAvatarSelector =
        useSelector(updateSuccessAvatar) ?? false;
    ...
    const [showcurrentUserPassword, setShowcurrentUserPassword] =
        React.useState({
            showPassword: false,
        });
    ...
    const selectFile = (event: any) => {
        ...
        getBase64(event.target.files[0]).then((result: any) => {
            dataUrlToFile(result, event.target.files[0].name).then(
                (value: any) => {
                    ...
                    <Grid item xs={12} sm={3} sx={{ textAlign: 'center' }}>
                        ...
                        (entityCountOffersByUserSelector?.countFindOffers ||
                            ...
                            <Box>
                                <StatisticOffers
                                    countOffersByUser={
                                        entityCountOffersByUserSelector
                                    }
                                    t={t}
                                />
                            </Box>
                        ...
                        <Paper elevation={3} sx={{ p: 2 }}>
                            <form onSubmit={formik.handleSubmit}>
                                <Box sx={{ mt: 2 }}>
                                    <h5 className="mb-4">
                                        {t<string>(
                                            'account.label_personnel_details'
                                        )}
                                        {!showEditInfos ? (
                                            <IconButton
                                            ...
                                            <Grid item xs={12} md={12}>
                                                ...
                                                >
                                                    ...
                                                    <LoadingButton
                                                        ...
                                                        type="submit"
                                                        loading={
                                                            loadingUpdateInfosAccountSelector
                                                        }
                            ...
                            <Paper elevation={3} sx={{ p: 2, mt: 4 }}>
                                <form onSubmit={formikPassword.handleSubmit}>
                                    <Box sx={{ mt: 2 }}>
                                        <h5 className="mb-4">
                                            {t<string>(
                                                'account.label_password_details'
                                            )}
                                            {!showEditPassword ? (
                                                <IconButton
                                                    aria-label="upload picture"
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid item xs={12}>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {t<string>(
                                                            'account.label_current_password'
                                                        )}
                                                    </InputLabel>
                                                    <OutlinedInput
                                                        id="currentPassword"
                                                        ...
                                                        endAdornment={
                                                            <InputAdornment position="end">
                                                                <IconButton
                                                                    ...
                                                                    onClick={
                                                                        handleClickShowcurrentUserPassword
                                                                    }
                                                                    onMouseDown={
                                        ...
                                        >
                                            ...
                                            <Grid item xs={12} md={6}>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {t<string>(
                                                            'account.label_conf_new_password'
                                                        )}
                                                    </InputLabel>
                                                    <OutlinedInput
                                                ...
                                                <Grid item xs={12} md={12}>
                                                    ...
                                                    >
                                                        ...
                                                        <LoadingButton
                                                            ...
                                                            type="submit"
                                                            loading={
                                                                loadingPasswordAccountSelector
                                                            }
                                                            loadingPosition="start"
                                                            startIcon={
                                                                <CheckIcon />
