                ...
                >
                    <Grid item xs={12}>
                        <Breadcrumbs aria-label="breadcrumb">
                            ...
                            <Typography color="text.primary">{t<string>('contact_us.title_contact_us')}</Typography>
                        </Breadcrumbs>
                    </Grid>
                </Grid>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <FormControl fullWidth error={formik.touched.name && Boolean(formik.errors.name)} size="small">
                                            ...
                                            <OutlinedInput
                                                ...
                                                color="secondary"
                                            />
                                            {formik.touched.name && formik.errors.name ? <FormHelperText id="component-helper-text">{t<string>(formik.errors.name)}</FormHelperText> : null}
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <FormControl fullWidth error={formik.touched.email && Boolean(formik.errors.email)} size="small">
                                            ...
                                            <OutlinedInput
                                                ...
                                                color="secondary"
                                            />
                                            {formik.touched.email && formik.errors.email ? <FormHelperText id="component-helper-text">{t<string>(formik.errors.email)}</FormHelperText> : null}
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item xs={12}>
                                        <FormControl fullWidth error={formik.touched.subject && Boolean(formik.errors.subject)} size="small">
                                            ...
                                            <OutlinedInput
                                                ...
                                                color="secondary"
                                            />
                                            {formik.touched.subject && formik.errors.subject ? <FormHelperText id="component-helper-text">{t<string>(formik.errors.subject)}</FormHelperText> : null}
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} md={12}>
                                        <FormControl fullWidth sx={{ mt: 3 }} error={formik.touched.message && Boolean(formik.errors.message)} size="small">
                                            ...
                                            <OutlinedInput
                                                ...
                                                color="secondary"
                                            />
                                            {formik.touched.message && formik.errors.message ? <FormHelperText id="component-helper-text">{t<string>(formik.errors.message)}</FormHelperText> : null}
                                        </FormControl>
                                    </Grid>

                                    <Grid item xs={12} md={12}>
                                        <ReCAPTCHA sitekey={AllAppConfig.RECAPTCHA_CONTACT_US.SITE_KEY} onChange={onChange} ref={recaptchaRef} />
                                        {formik.touched.captchaResponse && formik.errors.captchaResponse ? (
                                            <FormHelperText className="color-orange">{t<string>(formik.errors.captchaResponse)}</FormHelperText>
                                        ) : null}
                                    </Grid>

                                    <Grid item xs={12} md={12}>
                                        <LoadingButton loading={loading} fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} color="secondary" type="submit">
                    ...
                    <Grid item xs={12} sm={6} sx={{ p: 2 }}>
                        ...
                        <List sx={{}}>
                            <ListItem alignItems="flex-start">
                                ...
                                <ListItemText primary={t<string>('common.label_email')} secondary="srfgroup.contact@gmail.com" />
                            </ListItem>
                            ...
                            <ListItem alignItems="flex-start">
                                ...
                                <ListItemText primary={t<string>('common.label_phone')} secondary="+216 21 636 339 -  +216 73 900 850" />
                            </ListItem>
                            <Divider variant="inset" component="li" />
                            <ListItem alignItems="flex-start">
                                <ListItemAvatar>
                                ...
                                <ListItemText primary={t<string>('common.label_address')} secondary="Rue Montreal Skanes ElMechref, 5000, Monastir, Tunisia" />
                            </ListItem>
                            <Divider variant="inset" component="li" />
                            <ListItem alignItems="flex-start">
                                <ListItemAvatar>
                                ...
                                <ListItemText primary={t<string>('common.label_google_maps')} secondary="Tunis, Tunisia" />
                            </ListItem>
                        </List>
                    </Grid>
                </Grid>
