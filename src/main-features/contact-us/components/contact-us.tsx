                ...
                <Grid container sx={{ mt: 6 }}>
                    <Grid item xs={12} sm={6}>
                        <Paper elevation={3} sx={{ p: 2 }}>
                            <h3 className="mb-3">
                                {t<string>('contact_us.label_write_us')}
                            </h3>
