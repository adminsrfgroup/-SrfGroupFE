            ...
            data: [
                {
                    ...
                    amt: Math.max(this.props.countOffersByUser.countSellOffers, this.props.countOffersByUser.countRentOffers, this.props.countOffersByUser.countFindOffers),
                    cnt: 590,
                },
                {
                    ...
                    <div className="area-chart-wrapper-container">
                        <ResponsiveContainer width="100%" height="100%">
                            <ComposedChart width={400} height={400} data={this.state.data}>
                                ...
                                <Area type="monotone" dataKey="amt" fill="#fc3" stroke="#8884d8" />
